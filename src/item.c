...
const int items[] = {
    ...
    COBBLE,        LIGHT_STONE, WATER,        LAVA,          DARK_STONE,
    CHEST,         LEAVES,      TALL_GRASS,   YELLOW_FLOWER, RED_FLOWER,
    PURPLE_FLOWER, SUN_FLOWER,  WHITE_FLOWER, BLUE_FLOWER,   COLOR_00,
...
const int blocks[256][6] = {
    ...
    { 0, 0, 0, 0, 0, 0 },             // 22
    { 0, 0, 0, 0, 0, 0 },             // 23
    { 31, 31, 31, 31, 31, 31 },       // 24 - water
    { 30, 30, 30, 30, 30, 30 },       // 25 - lava
    { 0, 0, 0, 0, 0, 0 },             // 26
    { 0, 0, 0, 0, 0, 0 },             // 27
    { 0, 0, 0, 0, 0, 0 },             // 28
    { 0, 0, 0, 0, 0, 0 },             // 29
