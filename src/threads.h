/* threads.h n'est pas supporté dans glibc mais l'est dans musl. Pour essayer de
 * garantir la compilation j'ai copié l'équivalent du standard C11 pour les
 * threads dans ce fichier, domaine public, depuis
